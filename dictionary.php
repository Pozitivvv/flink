...
if (isset($_GET['ajax']) && $_GET['ajax'] === '1') {
    ...
    if ($words) {
        foreach ($words as $word) {
            ...
            // Добавляем кнопку звука, если она нужна в HTML (опционально, JS сам обрабатывает клик по ячейке)
            echo '</td>';
...
<head>
    ...
    <style>
        ...
        .loading-spinner { text-align: center; padding: 10px; display: none; color: #666; }
...
<div class="container">
    <div class="page-header">
        <a href="dashboard.php" class="back-btn">
            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="square" stroke-linejoin="miter"><path d="M15 18l-6-6 6-6"/></svg>
        </a>
        <h1>📚 Мій словник</h1>
    ...
    <a href="add_word.php" class="fab">
        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5"><line x1="12" y1="5" x2="12" y2="19"></line><line x1="5" y1="12" x2="19" y2="12"></line></svg>
    </a>
</div>
